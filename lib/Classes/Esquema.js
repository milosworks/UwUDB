...
class Esquema {
    ...
    /**
     * Crea un esquema para una db
     * @param {object} obj - Los datos de un esquema
     */
    constructor(obj) {
    ...
    _formatType(value, name) {
        ...
        if (Array.isArray(value)) throw new uwuDBError('EL objeto no debe ser un array!')
        ...
        if (VALID_TYPES.includes(value)) {
            ...
            if (keys.includes('default')) {
                if (typeof value.default !== value.type) throw new uwuDBError(`El tipo del valor default debe ser al mismo tipo de la propiedad, se recibio '${typeof value.default}' y deberia ser '${value.type}'`)
